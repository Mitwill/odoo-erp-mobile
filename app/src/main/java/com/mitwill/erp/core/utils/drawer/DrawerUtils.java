 ...
 */
package com.mitwill.erp.core.utils.drawer;
...
import com.mitwill.erp.config.Addons;
import com.mitwill.erp.core.account.ProfileActivity;
import com.mitwill.erp.core.support.addons.OAddon;
...
public class DrawerUtils {
    ...
    public static List<ODrawerItem> getDrawerItems(Context context) {
        ...
        //orders menu for the orders activity
/*
        List<ODrawerItem> menuOrder = new ArrayList<>();
        menuOrder.add(new ODrawerItem(OrdersActivity.class.getSimpleName())
                .setTitle("Orders")
                .setIcon(R.drawable.ic_orders)
                .setInstance(OrdersActivity.class));
        items.addAll(menuOrder);
*/
    ...
    public static List<ODrawerItem> baseSettingsItems(Context context) {
        ...
        settings.add(new ODrawerItem(key).setTitle(OResource.string(context, R.string.title_profile))
                .setInstance(ProfileActivity.class).setIcon(R.drawable.ic_action_user));
        return settings;
    }
