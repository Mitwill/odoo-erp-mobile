 ...
 */
package com.mitwill.erp.core.rpc.helper;

import android.os.Bundle;
import android.util.Log;

import com.mitwill.erp.core.rpc.handler.OdooVersionException;
import com.mitwill.erp.core.rpc.helper.utils.OBundleUtils;
...
public class OdooVersion {
    ...
    public static OdooVersion parseVersion(OdooResult result) throws OdooVersionException {
        ...
        try {
            ...
            ex.printStackTrace();
//            {protocol_version=1.0, server_serie=8.0, server_version=8.0, server_version_info=[8.0, 0.0, 0.0, final, 0.0]}
            //set the default values
            version.setServerSerie( "8.0" );
            version.setServerVersion( "8.0" );
            version.setVersionNumber( 8 );
            version.setVersionType( "0" );
            version.setVersionRelease( "final" );
        }
        Log.d( TAG, "parseVersion: "+version );
        return version;
    }
