...
public class About extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextView versionName, versionCode, aboutLine2, aboutLine3, aboutLine4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            String versionCodeName = packageManager.getPackageInfo(getPackageName(), 0).versionCode + "";
    ...
    public void onClick(View v) {
        if (!pref.getBoolean(Constants.PreferenceConstants.DEVELOPER_MODE, false)) {
            ...
            if (click_count == 5) {
                pref.setBoolean(Constants.PreferenceConstants.DEVELOPER_MODE, true);
