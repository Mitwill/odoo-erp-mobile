package com.mitwill.erp.core.rpc.wrapper;
...
import com.mitwill.erp.core.rpc.helper.OdooSession;
import com.mitwill.erp.core.rpc.helper.OdooUserCurrency;
import com.mitwill.erp.core.rpc.helper.OdooVersion;
import com.mitwill.erp.core.rpc.helper.utils.OdooLog;
import com.mitwill.erp.core.rpc.helper.utils.gson.OdooRecord;
import com.mitwill.erp.core.rpc.helper.utils.gson.OdooResponse;
import com.mitwill.erp.core.rpc.helper.utils.gson.OdooResult;
import com.mitwill.erp.core.rpc.http.OdooSafeClient;
import com.mitwill.erp.core.rpc.listeners.IDatabaseListListener;
import com.mitwill.erp.core.rpc.listeners.IModuleInstallListener;
...
import com.mitwill.erp.core.rpc.listeners.OdooSyncResponse;
...
public class OdooWrapper<T> implements Response.Listener<JSONObject> {
    ...
    public OUser authenticate( String username, String password, String database ) {
        ...
        Log.d( TAG, "authenticate: "+userResult );

        if (userResult != null && !(userResult.get("uid") instanceof Boolean)) {
...
//            }
    ...
    private void callMethod( String model, String method, OArguments arguments,
        ...
        try {
            ...
            Log.d( TAG, "callMethod: "+params.toString() );
            newJSONPOSTRequest( url, params, callback, backResponse );
        } catch ( Exception e ) {
            OdooLog.e( e, e.getMessage() );
        }
