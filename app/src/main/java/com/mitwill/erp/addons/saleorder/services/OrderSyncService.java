package com.mitwill.erp.addons.saleorder.services; /**
...
public class OrderSyncService extends OSyncService {
    public static final String TAG = OrderSyncService.class.getSimpleName();
