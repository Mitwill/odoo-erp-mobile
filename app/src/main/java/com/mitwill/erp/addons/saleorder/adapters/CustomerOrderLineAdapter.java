...
public class CustomerOrderLineAdapter extends ArrayAdapter<SampleSaleOrderLine> {

    private ArrayList<SampleSaleOrderLine> sampleSaleOrderLines;
    private Context context;

    public CustomerOrderLineAdapter(@NonNull Context context, ArrayList<SampleSaleOrderLine> sampleSaleOrderLines) {
        super(context, R.layout.sale_order_line_list_item, sampleSaleOrderLines);
        this.context = context;
        this.sampleSaleOrderLines = sampleSaleOrderLines;
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        SampleSaleOrderLine sampleSaleOrderLine = sampleSaleOrderLines.get(position);
    ...
    @Override
    public int getCount() {
        return sampleSaleOrderLines.size();
    }
}
