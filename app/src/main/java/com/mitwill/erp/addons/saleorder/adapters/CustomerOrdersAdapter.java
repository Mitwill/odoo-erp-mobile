package com.mitwill.erp.addons.saleorder.adapters;
...
public class CustomerOrdersAdapter extends ArrayAdapter<SampleSaleOrder> {

    private static final String TAG = CustomerOrdersAdapter.class.getSimpleName();
    private ArrayList<SampleSaleOrder> customerSampleOrders;
     ...
     * @param customerSampleOrders The resource ID for a layout file containing a TextView to use when
     */
    public CustomerOrdersAdapter( Context context, ArrayList<SampleSaleOrder> customerSampleOrders ) {
    ...
    public View getView( int position, @Nullable View convertView, @NonNull ViewGroup parent ) {
        ...
        SampleSaleOrder sampleSaleOrder = customerSampleOrders.get( position );
